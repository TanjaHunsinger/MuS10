...
d <- data.frame(treatment=c(x,y), id = factor(year_unempM)) 
f <- data.frame(treatment=c(x,y), id= factor(year_unempV)) 
boxplot(d[1],  ylab= "Unemployment Rate in %",main="Unemployment rate between 1970 and 1986", xlab = "Michigan", ylim=range(0:20))
boxplot(f[1],  ylab= "Unemployment Rate in %",main="Unemployment rate between 1970 and 1986", xlab = "West_Verginia",ylim = range(0:20))
...
x<-Vermont$street_capital
y<-R_Island$street_capital

d2 <- data.frame(treatment=c(x2,y2), id= factor(year_streer_capV))
f2 <- data.frame(treatment=c(x2,y2), id= factor(year_street_capV))

boxplot(d2[1], ylab = "Highway and street capital",xlab = "Vermont",main="Highway & street capital between 1970 and 1986") 
boxplot(f2[1], ylab = "Highway & street capital",xlab = "R_Island",main="Highway and street capital between 1970 and 1986")
